...
<body
            ...
            <nav class="flex gap-4 justify-end items-center">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="inline-block py-1.5 px-5 text-sm leading-normal rounded-sm border border-[#19140035] text-[#1b1b18] dark:text-[#EDEDEC] dark:border-[#3E3E3A] dark:hover:border-[#62605b] hover:border-[#1915014a]">
                        Dashboard
                    </a>
                @else
                    <a href="{{ route('login') }}"
                        class="inline-block py-1.5 px-5 text-sm leading-normal rounded-sm border border-transparent text-[#1b1b18] dark:text-[#EDEDEC] dark:hover:border-[#3E3E3A] hover:border-[#19140035]">
                        Log in
                    </a>
    ...
    <div
        class="flex justify-center items-center w-full opacity-100 transition-opacity duration-750 starting:opacity-0 lg:grow">
        <main class="flex flex-col-reverse w-full lg:flex-row lg:max-w-4xl max-w-[335px]">
            <div
                class="flex-1 p-6 pb-12 bg-white rounded-br-lg rounded-bl-lg lg:p-20 lg:rounded-br-none lg:rounded-tl-lg text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                ...
                <ul class="flex flex-col mb-4 lg:mb-6">
                    <li
                        class="flex relative gap-4 items-center py-2 before:border-l before:border-[#e3e3e0] before:top-1/2 before:bottom-0 before:left-[0.4rem] before:absolute dark:before:border-[#3E3E3A]">
                        <span class="relative py-1 bg-white dark:bg-[#161615]">
                            <span
                                class="flex justify-center items-center w-3.5 h-3.5 rounded-full border bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border-[#e3e3e0] dark:bg-[#161615] dark:border-[#3E3E3A]">
                                <span class="w-1.5 h-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]"></span>
                            </span>
                        </span>
                        <span>
                            Read the
                            <a href="https://laravel.com/docs" target="_blank"
                                class="inline-flex items-center ml-1 space-x-1 font-medium underline underline-offset-4 text-[#f53003] dark:text-[#FF4433]">
                    ...
                    <li
                        class="flex relative gap-4 items-center py-2 before:border-l before:border-[#e3e3e0] before:bottom-1/2 before:top-0 before:left-[0.4rem] before:absolute dark:before:border-[#3E3E3A]">
                        <span class="relative py-1 bg-white dark:bg-[#161615]">
                            <span
                                class="flex justify-center items-center w-3.5 h-3.5 rounded-full border bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] border-[#e3e3e0] dark:bg-[#161615] dark:border-[#3E3E3A]">
                                <span class="w-1.5 h-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]"></span>
                ...
                <ul class="flex gap-3 text-sm leading-normal">
                    <li>
                        <a href="https://cloud.laravel.com" target="_blank"
                            class="inline-block py-1.5 px-5 text-sm leading-normal text-white rounded-sm border border-black hover:bg-black hover:border-black bg-[#1b1b18] dark:bg-[#eeeeec] dark:border-[#eeeeec] dark:text-[#1C1C1A] dark:hover:bg-white dark:hover:border-white">
                            Deploy now
                        </a>
                    </li>
                </ul>
            ...
            <div
                class="overflow-hidden relative -mb-px w-full rounded-t-lg lg:mb-0 lg:-ml-px lg:rounded-t-none lg:rounded-r-lg bg-[#fff2f2] aspect-[335/376] shrink-0 lg:aspect-auto lg:w-[438px] dark:bg-[#1D0002]">
                {{-- Laravel Logo --}}
                <svg class="w-full max-w-none opacity-100 transition-all translate-y-0 text-[#F53003] duration-750 starting:opacity-0 starting:translate-y-6 dark:text-[#F61500]"
                ...
                {{-- Light Mode 12 SVG --}}
                <svg class="relative -ml-8 max-w-none lg:ml-0 dark:hidden w-[448px] -mt-[4.9rem] lg:-mt-[6.6rem]"
                    viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g
                        class="opacity-100 transition-all delay-300 translate-y-0 duration-750 starting:opacity-0 starting:translate-y-4">
                        <path
                ...
                {{-- Dark Mode 12 SVG --}}
                <svg class="hidden relative -ml-8 max-w-none lg:ml-0 dark:block w-[448px] -mt-[4.9rem] lg:-mt-[6.6rem]"
                    viewBox="0 0 440 376" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g
                        class="opacity-100 transition-all delay-300 translate-y-0 duration-750 starting:opacity-0 starting:translate-y-4">
                        <path
                    ...
                    <g class="opacity-100 transition-all delay-300 translate-y-0 duration-750 starting:opacity-0 starting:translate-y-4"
